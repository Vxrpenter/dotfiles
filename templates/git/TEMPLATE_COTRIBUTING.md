...
1. Ensure compatibility with all supported platforms
2. Make sure your changes can be compiled without any errors/warnings
3. Only change code that handles internal functions when you absolutely need to
...
6. Do not use AI to write any code, comments, pull requests, issues etc. [Further info in CODE OF CONDUCT]
...
3. Create a pull request and propose your changes
